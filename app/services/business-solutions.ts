...
export const businessSolutions = {
  ...
  includes: [
    ...
    "Client portals, admin tools, and reporting views",
    "Scalable architecture for growing teams",
  ],
  perfectFor: [
    "Businesses replacing manual spreadsheets and fragmented tools",
    "Teams that need a clearer internal workflow",
    "Organizations building customer-facing portals or dashboards",
  ],
